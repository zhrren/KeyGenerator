...
namespace Mark.KeyGenerator
{
    public class KeyGenerator
    {
        ...
        /// </summary>
        public KeyGenerator(int numTimestampCharacters = 11, int numServerCharacters = 4, int numRandomCharacters = 5, string reservedValue = "", string delimiter = "-", int[] delimiterPositions = null)
        {
